...
@jsonrpc_function
def add_guess(request, type, namea, nameb, hot, end_time_interval, show_time_interval):
    """添加公告"""
    end_time_interval = int(end_time_interval)
    show_time_interval = int(show_time_interval)
    return guess_manager.add_guess(type, namea, nameb, hot, end_time_interval, show_time_interval)
