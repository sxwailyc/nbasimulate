...
from xba.config import SYSLOG_HOST, PathSettings, COMMON_CACHE, DEBUG
from xba.common.exception_mgr import format_except
...
class _InitLog(object):
    ...
    def force_init(self, prefix=''):        
        ...
        handler1 = handlers.RotatingFileHandler(filename=os.path.join(PathSettings.LOG, 'all.log'), maxBytes=1024*1024, backupCount=20)
