...
from webauth.config import SYSLOG_HOST, PathSettings, COMMON_CACHE
from webauth.common.exception_mgr import format_except
...
#        logdir = PathSettings.LOG
        
#        logfile = self.get_local_logfile(logdir, prefix)
#        
#        handler2 = handlers.TimedRotatingFileHandler(logfile, when='MIDNIGHT', backupCount=14)
#        handler2.setLevel(logging.DEBUG)
#        handler2.setFormatter(logging.Formatter(format2))
