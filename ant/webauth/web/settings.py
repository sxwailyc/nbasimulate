...
from webauth.config import DjangoSettings, DEBUG
import os
...
#    'webauth.business.middleware.channel.ChannelMiddleware',
    'webauth.common.jsonrpcserver.JSONRPCServerMiddleware',
#    'webauth.common.staticgenerator.middleware.StaticGeneratorMiddleware',
    #'django.contrib.auth.middleware.AuthenticationMiddleware',
)

ROOT_URLCONF = 'webauth.web.urls'
