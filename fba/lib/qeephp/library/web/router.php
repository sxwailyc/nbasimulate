<?php
// $Id: router.php 2009 2009-01-08 18:52:43Z dualface $
 ...
 * @version $Id: router.php 2009 2009-01-08 18:52:43Z dualface $
 * @package mvc
 */
...
class QRouter
{
     ...
     * @var string
     */
    protected $_reserve_matched_route_name;
    ...
    protected $_reserved_vars = array(
        QContext::UDI_MODULE     => QContext::UDI_MODULE,
        QContext::UDI_NAMESPACE  => QContext::UDI_NAMESPACE,
        QContext::UDI_CONTROLLER => QContext::UDI_CONTROLLER,
        QContext::UDI_ACTION     => QContext::UDI_ACTION,
    );
    ...
    function match($path)
    {
        ...
        foreach (array_keys($this->_rules) as $route_name)
        {
            ...
            if ($result)
            {
                ...
                foreach ($this->_reserved_vars as $varname)
                {
                    if (!isset($result[$varname])) $result[$varname] = '';
                }
                return $result;
            }
        }
    ...
    protected function _prepareRoute($route_name)
    {
        ...
        foreach ($route['defaults'] as $varname => $tmp)
        {
