               ...
               <TBODY>
                 <TR>
                    <TD width="116" bgColor="#eeeeee" height="18">
                      <IMG height="8" src="http://xbam1.web.17173.com/Images/Player/Ability/Color0.gif" width="<?php echo $player->speed;?>" />
                    </TD>
          ...
          <TD width="157">
             <TABLE cellSpacing="0" cellPadding="0" width="157" border="0">
               <TBODY>
                 <TR>
                    <TD width="116" bgColor="#eeeeee" height="18">
                      <IMG height="8" src="http://xbam1.web.17173.com/Images/Player/Ability/Color0.gif" width="<?php echo $player->bounce;?>" />
                    </TD>
          ...
          <TD width="157">
             <TABLE cellSpacing="0" cellPadding="0" width="157" border="0">
               <TBODY>
                 <TR>
                    <TD width="116" bgColor="#eeeeee" height="18">
                      <IMG height="8" src="http://xbam1.web.17173.com/Images/Player/Ability/Color0.gif" width="<?php echo $player->strength;?>" />
                    </TD>
          ...
          <TD width="157">
             <TABLE cellSpacing="0" cellPadding="0" width="157" border="0">
               <TBODY>
                 <TR>
                    <TD width="116" bgColor="#eeeeee" height="18">
                      <IMG height="8" src="http://xbam1.web.17173.com/Images/Player/Ability/Color0.gif" width="<?php echo $player->stamina;?>" />
                    </TD>
          ...
          <TD width="157">
             <TABLE cellSpacing="0" cellPadding="0" width="157" border="0">
               <TBODY>
                 <TR>
                    <TD width="116" bgColor="#eeeeee" height="18">
                      <IMG height="8" src="http://xbam1.web.17173.com/Images/Player/Ability/Color0.gif" width="<?php echo $player->shooting;?>" />
                    </TD>
          ...
          <TD width="157">
             <TABLE cellSpacing="0" cellPadding="0" width="157" border="0">
               <TBODY>
                 <TR>
                    <TD width="116" bgColor="#eeeeee" height="18">
                      <IMG height="8" src="http://xbam1.web.17173.com/Images/Player/Ability/Color0.gif" width="<?php echo $player->trisection;?>" />
                    </TD>
          ...
          <TD width="157">
             <TABLE cellSpacing="0" cellPadding="0" width="157" border="0">
               <TBODY>
                 <TR>
                    <TD width="116" bgColor="#eeeeee" height="18">
                      <IMG height="8" src="http://xbam1.web.17173.com/Images/Player/Ability/Color0.gif" width="<?php echo $player->dribble;?>" />
                    </TD>
          ...
          <TD width="157">
             <TABLE cellSpacing="0" cellPadding="0" width="157" border="0">
               <TBODY>
                 <TR>
                    <TD width="116" bgColor="#eeeeee" height="18">
                      <IMG height="8" src="http://xbam1.web.17173.com/Images/Player/Ability/Color0.gif" width="<?php echo $player->pass;?>" />
                    </TD>
          ...
          <TD width="157">
             <TABLE cellSpacing="0" cellPadding="0" width="157" border="0">
               <TBODY>
                 <TR>
                    <TD width="116" bgColor="#eeeeee" height="18">
                      <IMG height="8" src="http://xbam1.web.17173.com/Images/Player/Ability/Color0.gif" width="<?php echo $player->backboard;?>" />
                    </TD>
          ...
          <TD width="157">
             <TABLE cellSpacing="0" cellPadding="0" width="157" border="0">
               <TBODY>
                 <TR>
                    <TD width="116" bgColor="#eeeeee" height="18">
                      <IMG height="8" src="http://xbam1.web.17173.com/Images/Player/Ability/Color0.gif" width="<?php echo $player->steal;?>" />
                    </TD>
          ...
          <TD width="157">
             <TABLE cellSpacing="0" cellPadding="0" width="157" border="0">
               <TBODY>
                 <TR>
                    <TD width="116" bgColor="#eeeeee" height="18">
                      <IMG height="8" src="http://xbam1.web.17173.com/Images/Player/Ability/Color0.gif" width="<?php echo $player->blocked;?>" />
                    </TD>
