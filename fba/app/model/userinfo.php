...
/**
 * UserInfo 封装来自 user_information 数据表的记录及领域逻辑
 */
class UserInfo extends QDB_ActiveRecord_Abstract
{
    ...
    static function __define()
    {
        ...
        (
            ...
            (
                'nickname' => array
                (
                    array('max_length', 25, 'nickname不能超过 25 个字符'),

                ),

                'name' => array
                (
                    array('max_length', 50, 'name不能超过 50 个字符'),

                ),

                'sex' => array
                (
                    array('max_length', 1, 'sex不能超过 1 个字符'),

                ),

                'birthday' => array
                (
                    array('is_date', 'birthday必须是一个有效的日期'),

                ),

                'qq' => array
                (
                    array('max_length', 25, 'qq不能超过 25 个字符'),

                ),

                'msn' => array
                (
                    array('max_length', 50, 'msn不能超过 50 个字符'),
                ...
                'blog_url' => array
                (
                    array('max_length', 200, 'blog_url不能超过 200 个字符'),

                ),

                'avatar_url' => array
                (
                    array('not_empty', '头像链接不能为空'),
                    array('max_length', 200, '头像链接不能超过 200 个字符'),

                ),

                'signature' => array
                (
                    array('not_empty', '个性签名不能为空'),
                    array('max_length', 25, '个性签名不能超过 25 个字符'),
