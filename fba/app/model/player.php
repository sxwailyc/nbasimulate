...
/**
 * Player 封装来自 player 数据表的记录及领域逻辑
 */
class Player extends QDB_ActiveRecord_Abstract
{
    ...
    static function __define()
    {
        ...
        (
            ...
            (
                'name' => array
                (
                    array('max_length', 25, 'name不能超过 25 个字符'),
                ...
                'position' => array
                (
                    array('max_length', 25, 'position不能超过 25 个字符'),
                ...
                'teamid' => array
                (
                    array('is_int', 'teamid必须是一个整数'),

                ),

                'ability' => array
                (
                    array('is_int', 'ability必须是一个整数'),
