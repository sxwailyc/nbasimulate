...
/**
 * MatchDetail 封装来自 match_detail 数据表的记录及领域逻辑
 */
class MatchDetail extends QDB_ActiveRecord_Abstract
{
    ...
    static function __define()
    {
        ...
        (
            ...
            (
                'description' => array
                (
                    array('max_length', 1024, 'description不能超过 1024 个字符'),

                ),

                'time_msg' => array
                (
                    array('max_length', 40, 'time_msg不能超过 40 个字符'),

                ),

                'point_msg' => array
                (
                    array('max_length', 40, 'point_msg不能超过 40 个字符'),
