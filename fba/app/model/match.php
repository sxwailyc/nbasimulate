...
/**
 * Match 封装来自 match_main 数据表的记录及领域逻辑
 */
class Match extends QDB_ActiveRecord_Abstract
{
    ...
    static function __define()
    {
        ...
        (
            ...
            'validations' => array
            (
                'home_team_name' => array
                (
                    array('max_length', 100, 'home_team_name不能超过 100 个字符'),

                ),

                'visiting_team_name' => array
                (
                    array('max_length', 100, 'visiting_team_name不能超过 100 个字符'),

                ),

                'start_time' => array
                (
                    array('is_datetime', 'start_time必须是一个有效的日期时间字符串'),

                ),

                'point' => array
                (
                    array('max_length', 20, 'point不能超过 20 个字符'),
