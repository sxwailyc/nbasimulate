...
from gba.common import md5mgr, json, playerutil, exception_mgr
from gba.entity import PlayerBetchLog, DraftPlayer
from gba.client.betch.config import DraftAttributeConfig
...
class DraftPlayerCreator(object):
    ...
    def _create(self, location, level):
        ...
        for attribute in attributes:
            base = DraftAttributeConfig.get_attribute_config(attribute, location, level)
            ...
            current_value = value * random.random()
            if current_value + 15 < value - 10:
                current_value += 15
            setattr(player, attribute, current_value)
