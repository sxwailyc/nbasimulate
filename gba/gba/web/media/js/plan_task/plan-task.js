...
Ext.onReady(function(){
   // Ext.QuickTips.init();
    ...
    grid_current_task.getSelectionModel().on('selectionchange', function(sm){
        grid_current_task.removeCurrentBtn.setDisabled(sm.getCount() < 1 && current_page_privilege > 1);
    });
    ...
    var refresh_privilege_enable = function(privilege){
    	...
    	if(privilege < 2){
    		...
    		grid_plan_task.syncBtn.setDisabled(true);
    		grid_current_task.removeCurrentBtn.setDisabled(true);
    	}
    }
