...
CREATE TABLE `league` (
  ...
  `team_count` smallint(6) DEFAULT NULL,
  `created_time` datetime DEFAULT NULL,
  `updated_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=48600 DEFAULT CHARSET=utf8;
...
CREATE TABLE `team_tactical_detail` (
  ...
  `defend_tactical_type` tinyint(3) DEFAULT '1',
