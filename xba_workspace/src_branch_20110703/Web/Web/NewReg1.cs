namespace Web
{
    ...
    public class NewReg1 : Page
    {
        ...
        public string CEmail(string strEmail)
        {
            ...
            if (ROOTUserManager.HasEmail(strEmail))
            {
                return "2";
            }
            return "0";
        ...
        public string CNickName(string strNickName)
        {
            ...
            bool flag = ROOTUserManager.HasNickName(strNickName);
            if (strLength < 2)
            {
                return "1";
            }
        ...
        public string CUserName(string strUserName)
        {
            ...
            bool flag = ROOTUserManager.HasUserName(strUserName);
            if (strLength < 4)
            {
                return "1";
            }
