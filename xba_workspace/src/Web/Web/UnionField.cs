namespace Web
{
    ...
    public class UnionField : Page
    {
        ...
        private void FieldList()
        {
            ...
            this.sbList.Append("</tr>");
            DataTable table = BTPUnionFieldManager.GetUnionFieldTable(this.intUnionIDH, request, this.intPage, this.intPerPage, false);
            if (table != null)
            {
                string str3;
                foreach (DataRow row4 in table.Rows)
                {
                    string strIn = row4["ClubNameA"].ToString().Trim();
                    string str5 = row4["UnionNameA"].ToString().Trim();
                    int num5 = (int) row4["FieldID"];
                    int num6 = (int) row4["UnionIDH"];
                    int num7 = (int) row4["UserIDA"];
                    int num1 = (int) row4["UnionIDA"];
                    int num8 = (byte) row4["Status"];
                    int num9 = (int) row4["Reputation"];
                    int intFMatchID = (int) row4["FMatchID"];
                    string str6 = "-- --";
                    DateTime datIn = (DateTime) row4["CreateTime"];
                    DateTime time3 = (DateTime) row4["MatchTime"];
                    string strNickName = "-- --";
                    string str8 = "";
                    string str9 = "<span style='width:75px;text-align:center'>正式比赛时间" + StringItem.FormatDate(time3.AddSeconds(298.0), "MM-dd hh:mm") + "</span>";
                    switch (num8)
                    {
                        case 0:
                            ...
                            str8 = string.Concat(new object[] { "<a href='SecretaryPage.aspx?UID=", num7, "&Type=FIELDDEF&CID=", num5, "'>立刻应战</a>" });
                            goto Label_0623;

                        case 1:
                        {
                            int intUserID = (int) row4["UserIDH"];
                            strNickName = row4["ClubNameH"].ToString().Trim();
                        ...
                        case 2:
                        {
                            ...
                            str8 = "<font color=green>防守成功</font>";
                            goto Label_09D8;
                        }
                        default:
                            if (num8 > 2)
                            {
                                str8 = "<font color=red>防守失败</font>";
                                strNickName = row4["ClubNameH"].ToString().Trim();
                                DataRow row6 = BTPFriMatchManager.GetFriMatchRowByFID(intFMatchID);
                                if (row6 != null)
                                {
                                    int num17 = (int) row6["ScoreA"];
                                    int num18 = (int) row6["ScoreB"];
                                    int num19 = (int) row6["ClubIDA"];
                                    int num20 = (int) row6["ClubIDB"];
                                    if ((num17 > 0) || (num18 > 0))
                                    {
                                        str6 = string.Concat(new object[] { 
                ...
                Label_09D8:
                    this.sbList.Append("<tr>");
                    this.sbList.Append(string.Concat(new object[] { "<td align=\"right\" ><a href=\"ShowClub.aspx?Type=5&UserID=", num7, "\" title=\"来自：", str5, "\" target=\"Right\">", StringItem.GetShortString(strIn, 0x10, "."), "</a></td>" }));
                    this.sbList.Append("<td align=\"center\" >" + num9 + "</td>");
                    this.sbList.Append("<td align=\"left\" >" + strNickName + "</td>");
                    this.sbList.Append("<td align=\"center\" ><a href=\"javascript:;\" title=\"" + str9 + "\">" + StringItem.FormatDate(datIn, "MM-dd &nbsp; hh:mm") + "</a></td>");
                    this.sbList.Append("<td align=\"center\" >" + str8 + "</td>");
                ...
                int num22 = SessionItem.GetRequest("Back", 0);
                if (num22 > 0)
                {
                    str3 = string.Concat(new object[] { "UnionField.aspx?Back=", num22, "&Type=FIELDLIST&UID=", this.intUnionIDH, "&Category=", request, "&" });
                }
                else
                {
                    str3 = string.Concat(new object[] { "UnionField.aspx?Type=FIELDLIST&UID=", this.intUnionIDH, "&Category=", request, "&" });
                }
                this.GetMsgScript(str3);
                this.sbList.Append("<tr><td height='30' align='right' colspan='7'><span style='margin:0,180px,0,0'>" + this.strFind + "</span>" + this.GetMsgViewPage(str3) + "</td></tr>");
            }
            else
            {
        ...
        private void FieldUnion()
        {
            ...
            this.intPerPage = 10;
            DataTable table = BTPUnionFieldManager.GetUnionFieldHistoryTable(this.intUnionIDH, this.intPage, this.intPerPage, false);
            if (table != null)
            {
                string str;
                foreach (DataRow row in table.Rows)
                {
                    ...
                    string str5 = row["ClubNameA"].ToString().Trim();
                    string strIn = row["UnionNameH"].ToString().Trim();
                    string str7 = row["UnionNameA"].ToString().Trim();
                    ...
                    str5 = AccountItem.GetNickNameInfo(num2, str5, "Right", 12);
                    if (num5 == 6)
                    {
                        str2 = " <font color='red'>胜</font> ";
                        str3 = " <font color='red'>败</font> ";
                    ...
                    {
                        str2 = " <font color='red'>败</font> ";
                        str3 = " <font color='red'>胜</font> ";
                        if (BTPUnionManager.GetUnionRowByID(num4) != null)
                        {
                            str7 = string.Concat(new object[] { "<a href='Union.aspx?Type=UNION&Kind=UNIONINTRO&UnionID=", num4, "&Page=1'>", StringItem.GetShortString(str7, 0x10), "</a>" });
                        }
                    }
                    ...
                    this.sbList.Append("    <td align=\"right\" width=\"20\">" + str2 + "</td>\n");
                    this.sbList.Append("    <td align=\"center\" width=\"5\">:</td>\n");
                    this.sbList.Append("    <td align=\"left\" width=\"20\">" + str3 + "</td>\n");
                    this.sbList.Append("    <td align=\"left\">" + str7 + "</td>\n");
                ...
                int request = SessionItem.GetRequest("Back", 0);
                if (request > 0)
                {
                    str = string.Concat(new object[] { "UnionField.aspx?Back=", request, "&Type=FIELDUNION&UID=", this.intUnionIDH, "&" });
                }
                else
                {
                    str = "UnionField.aspx?Type=FIELDUNION&UID=" + this.intUnionIDH + "&";
                }
                this.GetMsgScript(str);
                this.sbList.Append("<tr><td height='30' align='right' colspan='8'>" + this.GetMsgViewPage(str) + "</td></tr>");
            }
            else
            {
        ...
        {
            switch (SessionItem.GetRequest("Type", 1))
            {
                case "FIELDLIST":
        ...
        public string MatchRunLoad()
        {
            ...
            switch (num2)
            {
                ...
                case 1:
                {
                    ...
                    int num24 = (int) onlineRowByUserID["UnionIDA"];
                    ...
                    time2 = (DateTime) onlineRowByUserID["MatchTime"];
                    time2 = time2.AddSeconds(298.0);
                ...
                default:
                    ...
                    {
                        int num11;
                        int num12 = (int) onlineRowByUserID["UserIDH"];
                        int num13 = (int) onlineRowByUserID["UserIDA"];
                        int num25 = (int) onlineRowByUserID["UnionIDH"];
                        int num26 = (int) onlineRowByUserID["UnionIDA"];
                        int num14 = (int) onlineRowByUserID["Reputation"];
                        intFMatchID = (int) onlineRowByUserID["FMatchID"];
                        ...
                        int num15 = Convert.ToInt32(strArray3[0].Trim());
                        int num16 = Convert.ToInt32(strArray4[0].Trim());
                        str14 = AccountItem.GetNickNameInfo(num12, str14, "Right", 0x10);
                        str15 = AccountItem.GetNickNameInfo(num13, str15, "Right", 0x10);
                        str12 = AccountItem.GetNickNameInfo(num12, str12, "Right", 0x10);
                        str13 = AccountItem.GetNickNameInfo(num13, str13, "Right", 0x10);
                        ...
                        int num27 = (int) onlineRowByUserID["ClubIDA"];
                        int num17 = (int) onlineRowByUserID["ClubIDB"];
                        int num18 = (int) onlineRowByUserID["ScoreA"];
                        int num19 = (int) onlineRowByUserID["ScoreB"];
                        string[] strArray5 = this.GetMatchTimes(onlineRowByUserID, intClubID, intFMatchID, num11).Split(new char[] { ',' });
                        string str18 = "";
                        int num20 = 0;
                        if (strArray5[0] != null)
                        {
                        ...
                        if (num11 == 1)
                        {
                            string str21 = string.Concat(new object[] { 
                                "<a href='", Config.GetDomain(), "VRep.aspx?Type=1&Tag=", intFMatchID, "&A=", num15, "&B=", num16, "' target='_blank'>比赛战报</a>  <a href='", Config.GetDomain(), "VStas.aspx?Type=1&Tag=", intFMatchID, "&A=", num15, "&B=", num16, 
                        ...
                        builder.Append("  <tr>\n");
                        builder.Append("    <td height=\"20\" align=\"center\" valign=\"bottom\" ><font color='green'>本次挑战抵押" + num14 + "威望</font></td>\n");
                        builder.Append("  </tr>\n");
                        builder.Append("  <tr>\n");
                        builder.Append("    <td height=\"180\" align=\"center\" id=\"tbText\">");
                        ...
                        if (num17 == intClubID)
                        {
                            if (num18 < num19)
                            {
                                builder.Append("    <td height=\"20\" align=\"center\" valign=\"bottom\" >挑战成功，您所在联盟获得了<font color=\"green\" style=\"font-size:16px\"><strong>" + num14 + "</strong></font>联盟威望</td>\n");
                            }
                            else
                            {
                                builder.Append("    <td height=\"20\" align=\"center\" valign=\"bottom\" >挑战失败，您所在联盟损失了<font color=\"red\" style=\"font-size:16px\"><strong>" + num14 + "</strong></font>联盟威望</td>\n");
                            }
                        }
                        else if (num18 > num19)
                        {
                        ...
                        {
                            builder.Append("    <td height=\"20\" align=\"center\" valign=\"bottom\" >防守失败，您所在联盟损失了<font color=\"red\" style=\"font-size:16px\"><strong>" + num14 + "</strong></font>联盟威望</td>\n");
                        }
                        builder.Append("  </tr>\n");
                        builder.Append("  <tr>\n");
                        if (num11 == 1)
            ...
            builder.Append(string.Concat(new object[] { "</table>|1;ReadMatchBegin(", Convert.ToInt32(span.TotalSeconds), ",'", StringItem.FormatDate(time2, "yy-MM-dd hh:mm:ss"), "')" }));
        Label_113D:
            return builder.ToString();
        }
        ...
        private void MatchUnion()
        {
            ...
            DataTable table = BTPUnionFieldManager.GetUnionFieldMatchTable(this.intUserID, this.intPage, this.intPerPage, false);
            if (table != null)
            {
                string str;
                foreach (DataRow row in table.Rows)
                {
                    ...
                    string strNickName = row["ClubNameH"].ToString().Trim();
                    string str3 = row["ClubNameA"].ToString().Trim();
                    DateTime datIn = (DateTime) row["MatchTime"];
                    datIn = datIn.AddSeconds(298.0);
                    byte num1 = (byte) row["Status"];
                    strNickName = AccountItem.GetNickNameInfo(intUserID, strNickName, "Right", 12);
                    str3 = AccountItem.GetNickNameInfo(num4, str3, "Right", 12);
                    string str4 = "";
                    string str5 = "";
                    if ((num7 > 0) || (num8 > 0))
                    {
                    ...
                    if (intUserID == this.intUserID)
                    {
                        ...
                        {
                            str4 = "<font color='red'>-" + num2 + "</font>";
                        }
                    }
                    else if (num7 < num8)
                    {
                        str4 = "<font color='green'>+" + num2 + "</font>";
                    }
                    else
                    {
                        str4 = "<font color='red'>-" + num2 + "</font>";
                ...
                if (request > 0)
                {
                    str = string.Concat(new object[] { "UnionField.aspx?Back=", request, "&Type=MATCHUNION&UID=", this.intUnionIDH, "&" });
                }
                else
                {
                    str = "UnionField.aspx?Type=MATCHUNION&UID=" + this.intUnionIDH + "&";
                }
                this.GetMsgScript(str);
                this.sbList.Append("<tr><td height='30' align='right' colspan='8'>" + this.GetMsgViewPage(str) + "</td></tr>");
            }
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            else
            {
                ...
                this.intUnionIDH = SessionItem.GetRequest("UID", 0);
