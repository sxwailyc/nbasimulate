namespace Web.zh.com.xba.match_1
{
    using System;
    ...
    [DebuggerStepThrough, DesignerCategory("code"), WebServiceBinding(Name="VOnlineReportSoap", Namespace="http://tempuri.org/")]
    public class VOnlineReport : SoapHttpClientProtocol
    {
        public VOnlineReport()
        {
            base.Url = "http://match-1.xba.com.cn/WebService/VOnlineReport.asmx";
        }
