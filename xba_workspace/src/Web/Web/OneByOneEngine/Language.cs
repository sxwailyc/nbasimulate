namespace Web.OneByOneEngine
{
    ...
    public class Language
    {
        ...
        {
            int num = RandomItem.rnd.Next(0, 20);
        ...
        {
            int num = RandomItem.rnd.Next(0, 14);
            StringBuilder builder = new StringBuilder();
            builder.Append("[突破]");
            switch (num)
            {
        ...
        {
            int num = RandomItem.rnd.Next(0, 11);
            StringBuilder builder = new StringBuilder();
            builder.Append("[快攻]");
            switch (num)
            {
        ...
        {
            int num = RandomItem.rnd.Next(0, 13);
            StringBuilder builder = new StringBuilder();
            builder.Append("[内线]");
            switch (num)
            {
        ...
        {
            int num = RandomItem.rnd.Next(0, 0x10);
            StringBuilder builder = new StringBuilder();
            builder.Append("[内线]");
            switch (num)
            {
        ...
        {
            int num = RandomItem.rnd.Next(0, 9);
            StringBuilder builder = new StringBuilder();
            builder.Append("[挡拆]");
            switch (num)
            {
        ...
        {
            int num = RandomItem.rnd.Next(0, 0x15);
            StringBuilder builder = new StringBuilder();
            builder.Append("[外线]");
            switch (num)
            {
        ...
        {
            int num = RandomItem.rnd.Next(0, 12);
            StringBuilder builder = new StringBuilder();
            builder.Append("[外线]");
            switch (num)
            {
        ...
        {
            int num = RandomItem.rnd.Next(0, 0x12);
            StringBuilder builder = new StringBuilder();
            builder.Append("[三分]");
            switch (num)
            {
        ...
        {
            int num = RandomItem.rnd.Next(0, 0x25);
            StringBuilder builder = new StringBuilder();
            builder.Append("[突破]");
            switch (num)
            {
        ...
        {
            int num = RandomItem.rnd.Next(0, 0x1a);
            StringBuilder builder = new StringBuilder();
            builder.Append("[突破]");
            switch (num)
            {
        ...
        {
            int num = RandomItem.rnd.Next(0, 0x3d);
            StringBuilder builder = new StringBuilder();
            builder.Append("[内线]");
            switch (num)
            {
        ...
        {
            int num = RandomItem.rnd.Next(0, 0x13);
            StringBuilder builder = new StringBuilder();
            builder.Append("[内线]");
            switch (num)
            {
        ...
        {
            int num = RandomItem.rnd.Next(0, 15);
            StringBuilder builder = new StringBuilder();
            builder.Append("[内线]");
            switch (num)
            {
        ...
        {
            int num = RandomItem.rnd.Next(0, 30);
            StringBuilder builder = new StringBuilder();
            builder.Append("[外线]");
            switch (num)
            {
        ...
        {
            int num = RandomItem.rnd.Next(0, 0x17);
            StringBuilder builder = new StringBuilder();
            builder.Append("[失误]");
            switch (num)
            {
