namespace Web
{
    ...
    public class VArrageChampion : Page
    {
        ...
        private void btnOK_Click(object sender, ImageClickEventArgs e)
        {
            ...
            {
                BTPXGroupMatchManager.ChampionManage(this.intClubID, this.intTag, strArrange);
                base.Response.Redirect("Report.aspx?Parameter=78b!Kind.TRYOUT^Index." + (this.intTag + 1));
            }
        }
