        ...
        private void SetTrainPlayer3()
        {
            ...
            if (playerRowByPlayerID != null)
            {
                ...
                if (this.intClubID3 == intClubID)
                {
                    ...
                    int num16 = (int) playerRowByPlayerID["JumpMax"];
                    int num17 = (int) playerRowByPlayerID["StrengthMax"];
                    int num18 = (int) playerRowByPlayerID["StaminaMax"];
                    int num19 = (int) playerRowByPlayerID["ShotMax"];
                    int num20 = (int) playerRowByPlayerID["Point3Max"];
                    int num21 = (int) playerRowByPlayerID["DribbleMax"];
                    int num22 = (int) playerRowByPlayerID["PassMax"];
                    int num23 = (int) playerRowByPlayerID["ReboundMax"];
                    int num24 = (int) playerRowByPlayerID["StealMax"];
                    int num25 = (int) playerRowByPlayerID["BlockMax"];
                    int num1 = (int) playerRowByPlayerID["AttackMax"];
                    int num47 = (int) playerRowByPlayerID["DefenseMax"];
                    int num48 = (int) playerRowByPlayerID["TeamMax"];
                    this.intTeamDay = (int) playerRowByPlayerID["TeamDay"];
                    int num26 = (int) playerRowByPlayerID["SpeedMax"];
                    int num27 = (int) playerRowByPlayerID["JumpMax"];
                    int num28 = (int) playerRowByPlayerID["StrengthMax"];
                    int num29 = (int) playerRowByPlayerID["StaminaMax"];
                    int num30 = (int) playerRowByPlayerID["ShotMax"];
                    int num31 = (int) playerRowByPlayerID["Point3Max"];
                    int num32 = (int) playerRowByPlayerID["DribbleMax"];
                    int num33 = (int) playerRowByPlayerID["PassMax"];
                    int num34 = (int) playerRowByPlayerID["ReboundMax"];
                    int num35 = (int) playerRowByPlayerID["StealMax"];
                    int num36 = (int) playerRowByPlayerID["BlockMax"];
                    int num49 = (int) playerRowByPlayerID["AttackMax"];
                    ...
                    int age = (byte) playerRowByPlayerID["Age"];
                    this.intParameter = ((((400 - (((30 - age) * 100) / 20)) + 100) * 200) - 0x1388) / 400;
                    ...
                    int num52 = (int) playerRowByPlayerID["TeamDay"];
                    byte num53 = (byte) playerRowByPlayerID["Category"];
                    ...
                    this.sbReturn.Append(string.Concat(new object[] { "\t\t\t\t\t<td width='78' align=\"left\"><a title='第", playerRowByPlayerID["BirthTurn"].ToString(), "轮生日' style='CURSOR: hand'>", age, "</a>&nbsp;<a title='球龄' style='CURSOR: hand'>[", num40, "]</a></td>\n" }));
                    this.sbReturn.Append("\t\t\t\t</tr>\n");
                    this.sbReturn.Append("\t\t\t\t<tr>\n");
                    ...
                    this.sbAbility.Append(string.Concat(new object[] { "\t\t\t<td width=\"44\" height=\"22\" align=\"center\"><input type='hidden' id='Ability1' value='", intAbility, "'><input type='hidden' id='AbilityMax1' value='", num26, "'>\n" }));
                    ...
                    this.sbAbility.Append("\t\t\t<td width=\"120\" align=\"left\"><span id='alt1'></span><input type=\"hidden\" id=\"UserPoint1\" value=\"" + PlayerHelper.GetUsePoint3(10, intAbility, intAbilityMax, skillPotential, age) + "\"></td>");
                    this.sbAbility.Append("\t\t</tr>\n");
                    if (num5 < num16)
                    {
                        str2 = "onclick=\"AddAbility(this,1)\" src=\"images/zengjia.gif\"";
                    ...
                    this.sbAbility.Append("\t\t<tr>\n");
                    this.sbAbility.Append(string.Concat(new object[] { "\t\t\t<td height=\"22\" align=\"center\">弹跳<input type='hidden' id='Ability2' value='", num5, "'><input type='hidden' id='AbilityMax2' value='", num27, "'></td>\n" }));
                    this.sbAbility.Append("\t\t\t<td width=\"157\" id='tdAbility2'>" + this.GetHtmlTable(num5, num16, "tblAbility2") + "\n");
                    this.sbAbility.Append("\t\t\t<td align=\"center\"><img id='btnAdd2' " + str2 + " style=\"cursor:pointer;\" width=\"12\" height=\"12\" alt=\"训练提升该项目值\"></td>\n");
                    this.sbAbility.Append("\t\t\t<td width=\"120\" align=\"left\"><span id='alt2'></span><input type=\"hidden\" id=\"UserPoint2\" value=\"" + PlayerHelper.GetUsePoint3(10, num5, num16, skillPotential, age) + "\"></td>");
                    this.sbAbility.Append("\t\t</tr>\n");
                    if (num6 < num17)
                    {
                        str2 = "onclick=\"AddAbility(this,1)\" src=\"images/zengjia.gif\"";
                    ...
                    this.sbAbility.Append("\t\t<tr>\n");
                    this.sbAbility.Append(string.Concat(new object[] { "\t\t\t<td height=\"22\" align=\"center\">强壮<input type='hidden' id='Ability3' value='", num6, "'><input type='hidden' id='AbilityMax3' value='", num28, "'></td>\n" }));
                    this.sbAbility.Append("\t\t\t<td width=\"157\" id='tdAbility3'>" + this.GetHtmlTable(num6, num17, "tblAbility3") + "\n");
                    this.sbAbility.Append("\t\t\t<td align=\"center\"><img id='btnAdd3' " + str2 + " style=\"cursor:pointer;\" width=\"12\" height=\"12\" alt=\"训练提升该项目值\"></td>\n");
                    this.sbAbility.Append("\t\t\t<td width=\"120\" align=\"left\"><span id='alt3'></span><input type=\"hidden\" id=\"UserPoint3\" value=\"" + PlayerHelper.GetUsePoint3(10, num6, num17, skillPotential, age) + "\"></td>");
                    this.sbAbility.Append("\t\t</tr>\n");
                    if (num7 < num18)
                    {
                        str2 = "onclick=\"AddAbility(this,1)\" src=\"images/zengjia.gif\"";
                    ...
                    this.sbAbility.Append("\t\t<tr>\n");
                    this.sbAbility.Append(string.Concat(new object[] { "\t\t\t<td height=\"22\" align=\"center\">耐力<input type='hidden' id='Ability4' value='", num7, "'><input type='hidden' id='AbilityMax4' value='", num29, "'></td>\n" }));
                    this.sbAbility.Append("\t\t\t<td width=\"157\" id='tdAbility4'>" + this.GetHtmlTable(num7, num18, "tblAbility4") + "\n");
                    this.sbAbility.Append("\t\t\t<td align=\"center\"><img id='btnAdd4' " + str2 + " style=\"cursor:pointer;\" width=\"12\" height=\"12\" alt=\"训练提升该项目值\"></td>\n");
                    this.sbAbility.Append("\t\t\t<td width=\"120\" align=\"left\"><span id='alt4'></span><input type=\"hidden\" id=\"UserPoint4\" value=\"" + PlayerHelper.GetUsePoint3(10, num6, num18, skillPotential, age) + "\"></td>");
                    this.sbAbility.Append("\t\t</tr>\n");
                    if (num8 < num19)
                    {
                        str2 = "onclick=\"AddAbility(this,1)\" src=\"images/zengjia.gif\"";
                    ...
                    this.sbAbility.Append("\t\t<tr>\n");
                    this.sbAbility.Append(string.Concat(new object[] { "\t\t\t<td height=\"22\" align=\"center\">投篮<input type='hidden' id='Ability5' value='", num8, "'><input type='hidden' id='AbilityMax5' value='", num30, "'></td>\n" }));
                    this.sbAbility.Append("\t\t\t<td width=\"157\" id='tdAbility5'>" + this.GetHtmlTable(num8, num19, "tblAbility5") + "\n");
                    this.sbAbility.Append("\t\t\t<td align=\"center\"><img id='btnAdd5' " + str2 + " style=\"cursor:pointer;\" width=\"12\" height=\"12\" alt=\"训练提升该项目值\"></td>\n");
                    this.sbAbility.Append("\t\t\t<td width=\"120\" align=\"left\"><span id='alt5'></span><input type=\"hidden\" id=\"UserPoint5\" value=\"" + PlayerHelper.GetUsePoint3(10, num8, num19, skillPotential, age) + "\"></td>");
                    this.sbAbility.Append("\t\t</tr>\n");
                    if (num9 < num20)
                    {
                        str2 = "onclick=\"AddAbility(this,1)\" src=\"images/zengjia.gif\"";
                    ...
                    this.sbAbility.Append("\t\t<tr>\n");
                    this.sbAbility.Append(string.Concat(new object[] { "\t\t\t<td height=\"22\" align=\"center\">三分<input type='hidden' id='Ability6' value='", num9, "'><input type='hidden' id='AbilityMax6' value='", num31, "'></td>\n" }));
                    this.sbAbility.Append("\t\t\t<td width=\"157\" id='tdAbility6'>" + this.GetHtmlTable(num9, num20, "tblAbility6") + "\n");
                    this.sbAbility.Append("\t\t\t<td align=\"center\"><img id='btnAdd6' " + str2 + " style=\"cursor:pointer;\" width=\"12\" height=\"12\" alt=\"训练提升该项目值\"></td>\n");
                    this.sbAbility.Append("\t\t\t<td width=\"120\" align=\"left\"><span id='alt6'></span><input type=\"hidden\" id=\"UserPoint6\" value=\"" + PlayerHelper.GetUsePoint3(10, num9, num20, skillPotential, age) + "\"></td>");
                    this.sbAbility.Append("\t\t</tr>\n");
                    if (num10 < num21)
                    {
                        str2 = "onclick=\"AddAbility(this,1)\" src=\"images/zengjia.gif\"";
                    ...
                    this.sbAbility.Append("\t\t<tr>\n");
                    this.sbAbility.Append(string.Concat(new object[] { "\t\t\t<td height=\"22\" align=\"center\">运球<input type='hidden' id='Ability7' value='", num10, "'><input type='hidden' id='AbilityMax7' value='", num32, "'></td>\n" }));
                    this.sbAbility.Append("\t\t\t<td width=\"157\" id='tdAbility7'>" + this.GetHtmlTable(num10, num21, "tblAbility7") + "\n");
                    this.sbAbility.Append("\t\t\t<td align=\"center\"><img id='btnAdd7' " + str2 + " style=\"cursor:pointer;\" width=\"12\" height=\"12\" alt=\"训练提升该项目值\"></td>\n");
                    this.sbAbility.Append("\t\t\t<td width=\"120\" align=\"left\"><span id='alt7'></span><input type=\"hidden\" id=\"UserPoint7\" value=\"" + PlayerHelper.GetUsePoint3(10, num10, num21, skillPotential, age) + "\"></td>");
                    this.sbAbility.Append("\t\t</tr>\n");
                    if (num11 < num22)
                    {
                        str2 = "onclick=\"AddAbility(this,1)\" src=\"images/zengjia.gif\"";
                    ...
                    this.sbAbility.Append("\t\t<tr>\n");
                    this.sbAbility.Append(string.Concat(new object[] { "\t\t\t<td height=\"22\" align=\"center\">传球<input type='hidden' id='Ability8' value='", num11, "'><input type='hidden' id='AbilityMax8' value='", num33, "'></td>\n" }));
                    this.sbAbility.Append("\t\t\t<td width=\"157\" id='tdAbility8'>" + this.GetHtmlTable(num11, num22, "tblAbility8") + "\n");
                    this.sbAbility.Append("\t\t\t<td align=\"center\"><img id='btnAdd8' " + str2 + " style=\"cursor:pointer;\" width=\"12\" height=\"12\" alt=\"训练提升该项目值\"></td>\n");
                    this.sbAbility.Append("\t\t\t<td width=\"120\" align=\"left\"><span id='alt8'></span><input type=\"hidden\" id=\"UserPoint8\" value=\"" + PlayerHelper.GetUsePoint3(10, num11, num22, skillPotential, age) + "\"></td>");
                    this.sbAbility.Append("\t\t</tr>\n");
                    if (num12 < num23)
                    {
                        str2 = "onclick=\"AddAbility(this,1)\" src=\"images/zengjia.gif\"";
                    ...
                    this.sbAbility.Append("\t\t<tr>\n");
                    this.sbAbility.Append(string.Concat(new object[] { "\t\t\t<td height=\"22\" align=\"center\">篮板<input type='hidden' id='Ability9' value='", num12, "'><input type='hidden' id='AbilityMax9' value='", num34, "'></td>\n" }));
                    this.sbAbility.Append("\t\t\t<td width=\"157\" id='tdAbility9'>" + this.GetHtmlTable(num12, num23, "tblAbility9") + "\n");
                    this.sbAbility.Append("\t\t\t<td align=\"center\"><img id='btnAdd9' " + str2 + " style=\"cursor:pointer;\" width=\"12\" height=\"12\" alt=\"训练提升该项目值\"></td>\n");
                    this.sbAbility.Append("\t\t\t<td width=\"120\" align=\"left\"><span id='alt9'></span><input type=\"hidden\" id=\"UserPoint9\" value=\"" + PlayerHelper.GetUsePoint3(10, num12, num23, skillPotential, age) + "\"></td>");
                    this.sbAbility.Append("\t\t</tr>\n");
                    if (num13 < num24)
                    {
                        str2 = "onclick=\"AddAbility(this,1)\" src=\"images/zengjia.gif\"";
                    ...
                    this.sbAbility.Append("\t\t<tr>\n");
                    this.sbAbility.Append(string.Concat(new object[] { "\t\t\t<td height=\"22\" align=\"center\">抢断<input type='hidden' id='Ability10' value='", num13, "'><input type='hidden' id='AbilityMax10' value='", num35, "'></td>\n" }));
                    this.sbAbility.Append("\t\t\t<td width=\"157\" id='tdAbility10'>" + this.GetHtmlTable(num13, num24, "tblAbility10") + "\n");
                    this.sbAbility.Append("\t\t\t<td align=\"center\"><img id='btnAdd10' " + str2 + " style=\"cursor:pointer;\" width=\"12\" height=\"12\" alt=\"训练提升该项目值\"></td>\n");
                    this.sbAbility.Append("\t\t\t<td width=\"120\" align=\"left\"><span id='alt10'></span><input type=\"hidden\" id=\"UserPoint10\" value=\"" + PlayerHelper.GetUsePoint3(10, num13, num24, skillPotential, age) + "\"></td>");
                    this.sbAbility.Append("\t\t</tr>\n");
                    if (num14 < num25)
                    {
                        str2 = "onclick=\"AddAbility(this,1)\" src=\"images/zengjia.gif\"";
                    ...
                    this.sbAbility.Append("\t\t<tr>\n");
                    this.sbAbility.Append(string.Concat(new object[] { "\t\t\t<td height=\"22\" align=\"center\">封盖<input type='hidden' id='Ability11' value='", num14, "'><input type='hidden' id='AbilityMax11' value='", num36, "'></td>\n" }));
                    this.sbAbility.Append("\t\t\t<td width=\"157\" id='tdAbility11'>" + this.GetHtmlTable(num14, num25, "tblAbility11") + "\n");
                    this.sbAbility.Append("\t\t\t<td align=\"center\"><img id='btnAdd11' " + str2 + " style=\"cursor:pointer;\" width=\"12\" height=\"12\" alt=\"训练提升该项目值\"></td>\n");
                    this.sbAbility.Append("\t\t\t<td width=\"120\" align=\"left\"><span id='alt11'></span><input type=\"hidden\" id=\"UserPoint11\" value=\"" + PlayerHelper.GetUsePoint3(10, num14, num25, skillPotential, age) + "\"></td>");
                    this.sbAbility.Append("\t\t</tr>\n");
