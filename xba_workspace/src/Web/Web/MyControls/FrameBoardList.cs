                    ...
                    for (int i = 0; i < intC; i++)
                    {
                        ...
                        if (num6 < boardCountByTopID)
                        {
                            ...
                            str = string.Concat(new object[] { 
                                obj2, "<td bgcolor='", str3, "' class='Forum003' height='50' width='30' align='center'><img src='", SessionItem.GetImageURL(), "Forum/BoardLogo/", str7, "' width='20' height='20'></td><td bgcolor='", str3, "' class='Forum003' height='50'><a href='FrameBoard.aspx?BoardID=", str4, "'><strong>", str5, "</strong></a><br><strong><font color='#333333'>主题数:</font></strong> <font color='#666666'>", num8, "</font><br><strong><font color='#333333'>版主:</font></strong> <font class='ForumTime'>", 
