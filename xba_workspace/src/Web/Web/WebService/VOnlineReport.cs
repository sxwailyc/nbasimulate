namespace Web.WebService
{
    ...
    public class VOnlineReport : WebService
    {
        ...
        {
            VOnlineReportData data;
            string quarterArrange = "";
            int num = (byte) Global.drParameter["RepRefreshSec"];
            int num2 = (byte) Global.drParameter["RepStartTime"];
            ...
            if (DateTime.Now >= time)
            {
                ...
                int num3 = (int) devMRowByDevMatchID["ClubHScore"];
                int num4 = (int) devMRowByDevMatchID["ClubAScore"];
            ...
            if (base.Session["RepSession"] == null)
            {
                ...
                else if ((((int) row2["ClubHID"]) == 0) || (((int) row2["ClubAID"]) == 0))
                {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        data = new VOnlineReportData(document.DataSet);
            ...
            if (quarterArrange == "")
            {
                data = (VOnlineReportData) base.Session["RepSession"];
