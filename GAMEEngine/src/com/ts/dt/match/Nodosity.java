...
public class Nodosity {
	...
	private void loadControllersFromDb() {
		...
		TeamTactics homeTeamTactics = tacticsDao.loadTeamTactics(context.getHomeTeamId(), context.getMatchType());
		TeamTactics visitingTeamTactics = tacticsDao.loadTeamTactics(context.getVisitingTeamId(), context.getMatchType());
