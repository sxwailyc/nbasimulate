...
public class ScrimmageResultCheckFactory {

	public static final String CHECK_CLASS_SUFFIXAL = "Check";
	public static final String CHECK_CLASS_PACKAGE_NAME = "com.ts.dt.match.check.scrimmage";

	private static ScrimmageResultCheckFactory checkFactory;

	private ScrimmageResultCheckFactory() {

	}

	public static ScrimmageResultCheckFactory getInstance() {

		if (checkFactory == null) {
			checkFactory = new ScrimmageResultCheckFactory();
		}
		return checkFactory;
	}
